...
GEMINI_SYSTEM_INSTRUCTION: str = (
    ...
    "familia_meal_planner (weekly fusion meal plan PDF texted to the household), brain (Grok knowledge "
...
DEEPSEEK_SYSTEM_INSTRUCTION_TEMPLATE: str = (
    ...
    "picks), happy_hour, bravo_scout, familia_meal_planner (the weekly meal-plan PDF), or brain — call "
    ...
    "7. PROACTIVE: If user mentions sports, meals, happy hours, or knowledge queries, you may offer to run "
    "the relevant job (e.g., 'I can run sharp_picks for you now') — but only run it once they say so.\n"
    "8. Recent conversation turns may be supplied as prior messages. Use them to resolve follow-ups: "
