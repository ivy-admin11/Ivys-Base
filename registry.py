...
TOOL_SPECS: Tuple[ToolSpec, ...] = (
    ...
    ToolSpec(
        ...
        description=(
            ...
            "bravo_scout (reality TV monitor), familia_meal_planner (Venezuelan-American-Asian "
            "fusion meal plan), brain (knowledge queries). Do NOT call this to answer a question, "
            "give a recipe or advice, or in reply to a bare 'yes'/'sure'/'send it' following a "
            "conversational offer — only when the message itself names a job and asks for it to run."
        ),
        params=(
            ToolParam(
                "job_name", "string",
